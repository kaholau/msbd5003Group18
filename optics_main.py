...
Testing_pt_centers = [[15.0,16.0],[45.0,55.0],[1.0,40.0],[40.0,5.0]]
Testing_pt_centers_dev = [10.0,20.0,10.0,10.0]
num_Of_Testing_pt = 50
...
op_rDis = result.map(lambda p: p.reachDis \
				if p.reachDis <float(deviation_From_Testing_Center)*2 else float(deviation_From_Testing_Center)*2)
